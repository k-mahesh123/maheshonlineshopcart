...
#button {
    ...
    background: 0000;
    background: -moz-linear-gradient(top, #f5f5f5 0%, ffff 100%);
...
<body>
		<div class="container">
			<div class="row main">
				...
				<c:url value="/updateuser?username=${user.username}" var="updateuser"></c:url>
                            
				
					<form class="error"  action="${updateuser}" method="post">
						<form:errors path="*" cssClass="error" element="div"/>
						<div class="form-group">
							<label for="name" class="cols-sm-2 control-label">Your Name</label>
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="FALSE"></i></span>
