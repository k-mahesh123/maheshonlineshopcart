...
<h2>Edit Product</h2>
<c:url value="/updateproduct?productid=${product.productid }" var="action"></c:url>
  <form:form  modelAttribute="Product" method="post" action="${action}" enctype="multipart/form-data">
   <table class="table table-bordered" >
   
   <center>
    <img src='<c:url value="/resources/imgs/${product.image}" />'/>
    </center>
      <tr><td><form:label path="productname">Product Name :</form:label></td>
              ...
              <tr><td><form:label path="productwaranty">Warranty :</form:label></td>
               <td><form:input path="productwaranty" value="${product.productwaranty}"/></td>
          
           <tr><td><form:label path="img">Product Image :</form:label></td>
               <td><form:input path="img" type="file"  value=" ${product.path}" /></td>
              
              <tr><td><form:label path="suppliername">Supplier Name:</form:label></td>
               <td><select name="Suppliername">
   				 <option value="">${product.suppliername}</option>
